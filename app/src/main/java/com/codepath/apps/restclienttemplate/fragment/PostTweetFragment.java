 ...
 */
public class PostTweetFragment extends DialogFragment implements View.OnClickListener{
    ...
    public static PostTweetFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tweetText.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                int charLimit = 140;
                int textSize = ((TextView)v).getText().toString().length();
                updateCharCount(charLimit - textSize);
...
//    }
    ...
    public void onClick(View v) {
        ...
        String tweetText =  this.tweetText.getText().toString();
        if (tweetText != null && tweetText.trim().length() > 0) {
            TimelineActivity activity = ((TimelineActivity)getActivity());
            activity.postTweet(tweetText);
            this.dismiss();
        }
    }
}
